...
if __name__ == '__main__':
    ...
    train_data = datagen.flow_from_directory(directory='/media/bousefsa1/My Passport/BD PPG/2 bases publiques/BP4D-Expressive-Segment',
                                             target_size=(120, 160), class_mode='categorical', batch_size=16,
