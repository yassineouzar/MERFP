...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
        ...
        print(len(list(self.class_emotions.keys())))
    ...
    def next(self):
        ...
        if self.class_mode == 'input':
            ...
            batch_y = np.zeros(len(list(self.class_emotions.keys())), dtype="object")
            #batch_y = emo
            #print(batch_y)
...
if __name__ == '__main__':
    ...
    train_data = datagen.flow_from_directory(directory='/media/bousefsa1/My Passport/BD PPG/2 bases publiques/BP4D-Expressive-Segment',
                                             target_size=(120, 160), class_mode='categorical', batch_size=4,
