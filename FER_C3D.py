...
def c3d(nb_classes = 4, input_shape = (100, 160, 120, 3), weight_decay=0.01, dropout_rate=0.2):

    model_input = Input(shape=input_shape)

    x = Conv3D(64, (3, 3, 3), strides=(1, 1, 1), padding='same',
               activation='relu', kernel_regularizer=l2(weight_decay))(model_input)
    x = MaxPooling3D((1, 2, 2), strides=(1, 4, 3), padding='same')(x)
    ...
    model = Model(inputs=model_input, outputs=x, name="c3d")
