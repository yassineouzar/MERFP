...
class mpFace:
    ...
    def __init__(self, width=640, height=480):
        ...
        self.faceMesh = self.mp.solutions.face_mesh.FaceMesh(False, 3, True, 0.5,
                                                             0.5)  # (staticFrame,number of faces,True for extra iris landmarks,trackingParameter,findingParameter)
        self.width = width
        self.height = height
    ...
    def faceLandmarksSimplified(self,
        ...
        points = [70, 63, 105, 66, 107, 55, 65, 52, 53, 46, 300, 293, 334, 296, 336, 285, 295, 282, 283, 276, 33, 246,
                  ...
                  398, 362, 382, 381, 380, 374, 373, 390, 249, 78, 191, 80, 81, 82, 13, 312, 311, 310, 415, 308, 324,
                  318, 402, 317, 14, 87, 178, 88, 95, 61, 185, 40, 39, 37, 0, 267, 269, 270, 409, 291, 375, 321, 405,
                  314, 17, 84, 181, 91, 146, 10, 338, 297, 332, 284, 251, 389, 356, 454, 323, 361, 288, 397, 365, 379,
