...
path_im = 'home/ouzar1/Desktop/New'
#path_im = '/media/ouzar1/Seagate Backup Plus Drive/Unzip_images'

path_save_im = '/media/ouzar1/Seagate Expansion Drive/validation_set/ROI_MMSE-HR_save'
print("begin0")
