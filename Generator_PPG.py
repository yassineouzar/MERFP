...
class DirectoryIterator(Iterator):
    ...
    def __init__(self, directory, image_data_generator,
        ...
        if class_mode not in {'categorical', 'binary', 'sparse',
                              'input', 'label', 'PPG', None}:
            raise ValueError('Invalid class_mode:', class_mode,
                             '; expected one of "categorical", '
                             '"binary", "sparse", "input", "PPG"'
                             ' or None.')
    ...
    def next(self):
        ...
        if self.class_mode == 'input':
            ...
            batch_bp = batch_y
            batch_emo = np.zeros((self.batch_size, len(list(self.class_emotions.keys()))), dtype="object")
            ...
            for j in range(self.batch_size):
                for k in range(len(list(self.class_emotions.keys()))):
                    ...
                    classes_emo = os.path.splitext(os.path.normpath(fname))[0][5:-5]

                    batch_emo[j,k] = classes_emo
                    batch_emo1 = (np.array(list(self.class_emotions.keys())) == batch_emo).astype(int)

        elif self.class_mode == 'label':

            batch_y = batch_y
        if self.class_mode == 'PPG':
            batch_bp = batch_y
            batch_emo = np.zeros((self.batch_size, len(list(self.class_emotions.keys()))), dtype="object")
            # batch_y1 = np.zeros((self.batch_size, len(list(self.class_emotions.keys()))), dtype="object")
        ...
        return batch_bp, batch_emo1

if __name__ == '__main__':

    datagen = ImageDataGenerator()
    train_data = datagen.flow_from_directory(directory='/home/ouzar1/Documents/pythonProject/BP4D-Expressive-Segment/BP4D-Expressive-Segment',
                                              label_dir='/home/ouzar1/Documents/pythonProject/BP4D-Expressive-Segment-bp',
                                             target_size=(120, 160), class_mode='PPG', batch_size=10,
...
if __name__ == '__main__':
    ...
    train_data = datagen.flow_from_directory(directory='/home/ouzar1/Documents/pythonProject/BP4D-Expressive-Segment/BP4D-Expressive-Segment',
                                              label_dir='/home/ouzar1/Documents/pythonProject/BP4D-Expressive-Segment-bp',
                                             target_size=(120, 160), class_mode='categorical', batch_size=10,
                                             frames_per_step=50, shuffle=False)
    ...
    for data in train_data:
        ...
        bp = data[1]
        label = data[2]
        print(image.shape, bp.shape, label.shape)
        #print(label)
        # print(np.mean(image),label)
...
if __name__ == '__main__':
    ...
    datagen = ImageDataGenerator()
    train_data = datagen.flow_from_directory(directory='/home/ouzar1/Documents/test/vid',
                                              label_dir='/home/ouzar1/Documents/test/bp',
                                             target_size=(120, 160), class_mode='label', batch_size=10,
                                             frames_per_step=50, shuffle=False)
